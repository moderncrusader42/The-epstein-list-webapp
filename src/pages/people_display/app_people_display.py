...
from src.pages.people_display.core_people import (
    ...
    _render_missing_person,
    _render_person_hero,
    _render_review_link_button,
...
def _read_asset(path: Path) -> str:
    try:
        ...
        logger.warning("Missing people display asset at %s", path)
        return ""
    ...
    try:
        ...
        if not slug:
            return _empty_detail_state(
                "<h2>The List</h2>",
                _render_profile_selection_prompt(),
                markdown_help,
                card_help,
                citation_source_options,
            )
        ...
        if person is None:
            return _empty_detail_state(
                ...
                _render_missing_person(slug),
                markdown_help,
                card_help,
                citation_source_options,
            )
        person["tag_catalog"] = _fetch_tag_catalog()
...
def make_people_display_app() -> gr.Blocks:
    ...
    with gr.Blocks(
        ...
        markdown_edit_btn.click(
            timed_page_load("/people-display", _toggle_markdown_editor, label="toggle_markdown_editor"),
        ...
        cancel_markdown_edit_btn.click(
            timed_page_load("/people-display", _cancel_markdown_editor, label="cancel_markdown_editor"),
        ...
        proposal_image_plus_btn.upload(
            timed_page_load("/people-display", _append_markdown_image, label="append_markdown_image"),
        ...
        submit_markdown_proposal_btn.click(
            timed_page_load("/people-display", _submit_markdown_proposal, label="submit_markdown_proposal"),
            inputs=[
                current_slug,
                proposal_note,
                proposal_markdown,
        ...
        card_edit_btn.click(
            timed_page_load("/people-display", _toggle_card_editor, label="toggle_card_editor"),
        ...
        cancel_card_edit_btn.click(
            timed_page_load("/people-display", _cancel_card_editor, label="cancel_card_editor"),
        ...
        submit_card_proposal_btn.click(
            timed_page_load("/people-display", _submit_card_proposal, label="submit_card_proposal"),
            inputs=[
                current_slug,
                card_proposal_note,
                card_proposal_name,
